...
│
├── src/                 ← v0.2 contracts (Acta · Honos · Tessera)
├── test/                ← Foundry probes verifying EIP-3009 on Arc USDC
│
├── deploy/
...
│   ├── DEMO.md                  ← end-to-end smoke test against the live facilitator
│   └── PUBLISHING.md            ← npm release runbook for @hidayahhtaufik/x402-arc
│
├── docker-compose.yml
└── foundry.toml
```
...
Drafts of these contracts live in `src/`; full milestone plan ships with v0.2.

### v0.3 — ecosystem
- [ ] Publish `@hidayahhtaufik/x402-arc` SDK to npm
