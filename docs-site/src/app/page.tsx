...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "sdk", label: "SDK (@hidayahhtaufik/x402-arc)", badge: "TS" },
  ...
  return (
    <section id="overview" style={{ scrollMarginTop: 96 }}>
      ...
      <ul>
        ...
        <li><strong>@hidayahhtaufik/x402-arc</strong> — shared SDK (EIP-712 + EIP-3009 + payment envelope codec)</li>
...
function Sdk() {
  return (
    <section id="sdk" style={{ scrollMarginTop: 96 }}>
      <SectionLabel>3.1 SDK · @hidayahhtaufik/x402-arc</SectionLabel>
      <p>
      ...
      <pre><code>{`// Buyer
import { signPayment } from "@hidayahhtaufik/x402-arc/client";
...
import { x402 } from "@hidayahhtaufik/x402-arc/server";
...
function Roadmap() {
  return (
    <section id="roadmap" style={{ scrollMarginTop: 96 }}>
      ...
      <ul>
        <li><code>@hidayahhtaufik/x402-arc</code> SDK on npm</li>
...
function Resources() {
  const resources = [
    {
      label: "Source code",
      desc: "Repository, issues, PRs, releases — hidayahhtaufik/aureus",
      kind: "REPO",
    ...
    },
    {
      ...
      desc: "End-to-end test script against the live facilitator",
      kind: "GUIDE",
      href: "https://github.com/hidayahhtaufik/aureus/blob/master/docs/DEMO.md",
    },
    {
      label: "Publishing to npm",
      desc: "One-time setup and per-release flow for @hidayahhtaufik/x402-arc",
      kind: "GUIDE",
      href: "https://github.com/hidayahhtaufik/aureus/blob/master/docs/PUBLISHING.md",
    },
    {
    ...
    },
    {
      ...
      desc: "The HTTP 402 protocol Aureus implements — x402-foundation/x402",
      kind: "EXTERNAL",
      href: "https://github.com/x402-foundation/x402",
    },
    {
      label: "Arc Network",
      desc: "Circle's stablecoin-native L1 — docs, RPC, chain primitives",
      kind: "EXTERNAL",
    ...
    {
      label: "Arcscan",
      desc: "Arc Testnet block explorer — verify every on-chain settlement",
      kind: "EXTERNAL",
      href: "https://testnet.arcscan.app",
    },
    {
      label: "Circle Developer Grants",
      desc: "Milestone-based USDC funding for stablecoin-native infra",
      kind: "EXTERNAL",
