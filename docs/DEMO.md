...
> Next:
>
> • `@hidayahhtaufik/x402-arc` SDK on npm
...
| Buyer gets 400 on retry | EIP-712 domain mismatch (wrong chainId or USDC version) | Confirm `ARC_CHAIN_ID=5042002` + USDC version `"2"` in `@hidayahhtaufik/x402-arc` constants |
