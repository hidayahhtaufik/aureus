...
`src/eip3009-signer.ts` and `src/x402-client.ts` are written to be self-contained — no imports from the facilitator package. They will be lifted into the published `@hidayahhtaufik/x402-arc` npm package later.
