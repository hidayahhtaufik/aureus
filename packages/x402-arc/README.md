...
```typescript
import { signEip3009Authorization } from "@auranode/x402-arc/client";
import { randomNonce } from "@auranode/x402-arc";
...
- **`@auranode/x402-arc`** — constants, types, EIP-712, EIP-3009 (no I/O)
- **`@auranode/x402-arc/client`** — buyer signer + x402 fetch client
- **`@auranode/x402-arc/server`** — facilitator HTTP client + Express middleware
